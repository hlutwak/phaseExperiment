...
close all;
clc;
% addpath(genpath('/Applications/Psychtoolbox'))v
...
%                                       [ 0, -0.15, .65]];                  % deg/s *up is down and down is up
    ...
    clusterDev                      = 1;                                    % 0 = one patch, 1 = cross shape;
...
%             observerTrajectory = repmat(translation/frame_rate, [nframes, 1]); %trajectory over one frame
    ...
    dot_density                     = 1;                                  % 1/dot_density = average degrees between apertures measured from the centers
