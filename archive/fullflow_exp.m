...
%vvv vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
    %-----Subject Settings------------------ 
    ...
    translation                     = [[ 0, 0.15, .65];[ 0, -0.15, .65]];             
%                                       [ 0, -0.15, .65]];                 % deg/s *up is down and down is up
    weberFrac                       = 1.2;                                    % magnitude deviation vector deg/s
    ...
    depth_limits                    = [cloud_dist(1)/1.75, middle_dist];       %limits of depths to test, first is original deviation distance
