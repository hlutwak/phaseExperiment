...
%         theta             = [0 180];
    ...
    dot_density                     = .7;
    jitter                          = 1;                                    % deg to jitter by
    numSame                         = 5;                                    % number of apertures that have same texture
    cut                             = 2;                                    % cut off freq 1:4 (depends on speed, larger speed have lower cyc/deg corresponding to freq 1
    ...
    devPos                          = [10; 6];               %[randi(view_window(1)/2);randi((view_window(2)-1)/2)]               % position of deviation (y-axis flipped when displaying)    
