...
%vvv vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
    %-----Subject Settings------------------ 
    ...
    frame_rate                      = 85;                                   % psychophysics room 85
...
%                                       [ 0, -0.15, .65]];                 % deg/s *up is down and down is up
    ...
    exclude                         = [-3, -3, 3, 2];                          % Don't place elements where the FOE will be
