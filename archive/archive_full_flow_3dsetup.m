...
%         theta             = [0 180];
    ...
    switch depth_structure
        ...
        case 3
            gaze_angle = -5;
            gazeRotation = [1, 0, 0; 0, cosd(gaze_angle), -sind(gaze_angle); 0, sind(gaze_angle), cosd(gaze_angle)];
            viewingdepths = [.5,200];
            ppcm = [64,-64];
            xyrat = pixels(1)/pixels(2);
            nframes = frame_rate*stimulus_duration;
            dim = [100,0,nframes+100]; %dimensions for ground plane
            xvals = linspace(-15,15,500);
            zvals = linspace(0, 100,800); 
