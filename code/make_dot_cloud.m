function [dots_m, dots_deg, dev0, dev1] = make_dot_cloud(density, jitter, cloud_dist, view_window, gabor_diam, exclude, devPos)
% Make a cloud of non overlapping random dots, with one always at deviation
...
%        dots/deg^2.
%
% dist tells you the range of how far the observer starts from a dot surface in m.
%
...
% gridx = (linspace(-view_window(1)/2, view_window(1)/2, round(view_window(1)*density)));
% gridy = (linspace(-view_window(2)/2, view_window(2)/2, round(view_window(2)*density)));
